...
//select style
if ($style == 'style1') {
	$document->addStyleSheet('plugins/content/jnillagallery/media/css/slider3-style1.css');
}
if ($style == 'style2') {
	$document->addStyleSheet('plugins/content/jnillagallery/media/css/slider3-style2.css');
}
...
<div class="jnilla-gallery slider" id="<?php echo $uid; ?>">
	<?php if($jnbox == 'true'): ?>
	<div class="slider-3 gallery <?php if($style == 'style1'){ echo 'style1';}else{ echo 'style2';} ?>">
		<?php else: ?>
		<div class="slider-3 <?php if($style == 'style1'){ echo 'style1';}else{ echo 'style2';} ?>">
			<?php endif; ?>
			<!-- Slider items -->
			<?php if($type == 'images'): ?>
			<!-- layout images -->
			<div class="gallery-items">
				...
				<?php $n++;
						...
						?>
				<div class="gallery-item <?php if($n==0 || $n<=2) echo 'default'.$n; ?>">
					<img class="jn-gallery-thumb jn-holder img" data-ratio="wide" src="<?php echo $galleryPath."/".$item; ?>"
					data-src="
					<?php echo $galleryPath."/".$item; ?>">
					<?php if($caption == 'true') : ?>
			...
			<div class="gallery-items">
				...
				<?php $n++;
						...
						$video = '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$idvideo.'?rel=0" frameborder="0" allowfullscreen></iframe>';
							...
							?>
				<div class="gallery-item videos <?php if($n==0 || $n<=2) echo 'default'.$n; ?>">
					<?php if($urlvideo): ?>
					<img class="jn-gallery-thumb jn-holder" data-ratio="wide" src="<?php echo $srcimage; ?>">
					<div class="rollover vid" data-src='<?php echo $video; ?>'><img src="plugins/content/jnillagallery/media/images/play.png"
						 alt="PLAY"></div>
					<?php else: ?>
					<img class="jn-gallery-thumb jn-holder jn-holder-block" data-ratio="wide" src="plugins/content/jnillagallery/media/images/no-videos.jpg">
					<?php endif; ?>
					<?php if($caption == 'true') : ?>
					<?php if($stylecaption == 'inside'): ?>
					<div class="carousel-caption">
